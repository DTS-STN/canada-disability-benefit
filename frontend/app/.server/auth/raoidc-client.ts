...
class RaoidcClient {
  ...
  private async generateClientAssertion(): Promise<string> {
    return await new SignJWT({})
      .setProtectedHeader({ alg: 'PS256', kid: this.generateJwkId(this.privateSigningJsonWebKey) })
   ...
   */
  private generateJwkId(jwk: webcrypto.JsonWebKey): string {
...
class RaoidcClientBuilder {
  ...
  /**
   * The client's private RSA key in PEM format, used for decryption and signing.
   */
   ...
   */
  public constructor(baseUrl: URL, clientId: string, privateKeyPem: string) {
